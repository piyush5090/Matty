...
const UserCard = ({ user, onDelete }) => {
  ...
  return (
    <div className="w-full max-w-md bg-gradient-to-br from-gray-900 to-gray-800 shadow-xl rounded-2xl border border-gray-700 mb-6 p-5 transition transform hover:scale-[1.02] hover:shadow-2xl">
      {/* Header */}
